...
window.EA_LOCATIONS = {
  "Argentina": {
    ...
    "Jujuy": ["San Salvador de Jujuy","Palpalá","Tilcara"],
    ...
    "Neuquén": ["Neuquén","San Martín de los Andes","Villa La Angostura","Cutral Có"],
    "Río Negro": ["Viedma","San Carlos de Bariloche","General Roca","Cipolletti"],
    "Salta": ["Salta","San Ramón de la Nueva Orán","Cafayate"],
